  ...
  return (
     <div className="md:col-span-6 lg:col-span-8 md:row-span-2 bg-card border border-border rounded-lg p-8 flex flex-col justify-between hover:scale-[1.02] lg:max-h-[450px] text-center sm:text-left">
          ...
          <div className="flex gap-2">
            <a
              href="#contact"
              className="bg-[#181818] text-white px-4 py-2 rounded-md hover:bg-white hover:border hover:text-[#181818] transition-colors text-medium font-medium flex items-center"
            >
              Get in touch
              <ArrowUpRight className="ml-2 h-4 w-4" />
            </a>

            <button className="border border-border text-foreground px-4 py-2 rounded-md hover:bg-[#181818] hover:text-white transition-colors text-medium font-medium">
