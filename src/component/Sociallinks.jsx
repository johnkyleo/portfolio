...
const Sociallinks = () => {
  return (
   <div data-aos="fade-left" className="md:col-span-3 lg:col-span-4 md:row-span-1 bg-card border border-border rounded-lg p-6 flex flex-col justify-between hover:scale-[1.02]">
