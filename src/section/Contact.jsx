...
function Contact() {
  ...
  return (
    <section id="contact" className="lg:py-16 py-10 h-[100vh] px-4">
     ...
     <h1 className="uppercase text-[40px] text-blue-900">Contact Me</h1>
     <hr className="w-[200px] h-px mx-auto border-black"/>
     </div>

     
    <div className="shadow-lg max-w-[500px] h-[500px] rounded-lg lg:mt-20 border-blue-900 border-2 mt-16 mx-auto">   
    <div className="w-full border-b-2 border-blue-900 h-[40px]">
        <div className="flex justify-between items-center">
            <hr className="w-[200px] border-2 border-blue-900 ml-5"/>
            <IoClose size={30}/>
        </div>
    </div>
      <form onSubmit={onSubmit} className="space-y-8 max-w-[80%] mx-auto mt-10">
          ...
          <button type="submit" className="py-3 px-5 text-sm font-semibold text-center rounded-md bg-blue-900 text-white">Send message</button>
      </form>
      </div>
    </section>
  );
